...
$endif$$endif$%
\documentclass[$if(fontsize)$$fontsize$,$endif$$if(lang)$$babel-lang$,$endif$$if(papersize)$$papersize$a4paper,$endif$$if(beamer)$ignorenonframetext,$if(handout)$handout,$endif$$if(aspectratio)$aspectratio=$aspectratio$,$endif$$endif$$for(classoption)$$classoption$$sep$,$endfor$]{$documentclass$}
$if(beamer)$
...
\par{\centering{\normalsize  \bfseries{\thetitle}}\par}
%\par{\centering{\normalsize  \bfseries{\thetitle}}\par}
	\end{minipage}
...
\titleformat{\section}{\normalsize\bf\raggedright}{}{1em}{}[{\titlerule[2pt]}]
\titlespacing{\section}{0pt}{3pt}{7pt}
\titleformat{\subsection}{\normalsize\bfseries}{}{0em}{\underline}%[\rule{3cm}{.2pt}]
%\titleformat{\subsection}{\normalsize\bfseries\centering}{}{0em}{\underline}%[\rule{3cm}{.2pt}]
